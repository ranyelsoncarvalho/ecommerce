		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-content-right">
					<form action="/checkout" class="checkout" method="post" name="checkout"> <!--envio do formulario para rota e o metodo utilizado-->
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											<table class="shop_table">
												...
												<tbody>
													<!--carregar os dados produto que estao no carrinho-->
												...
												<tfoot>
													<tr class="cart-subtotal"> <!--carregado do carrinho de compras-->
														<th>Subtotal</th>
