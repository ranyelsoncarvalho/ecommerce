    ...
    <div class="container">
        <div class="row">                
            <div class="col-md-6">
                ...
                <form action="/login" id="login-form-wrap" class="login" method="post"> <!--rota 'login' para o usuario fazer o cadastro ou acessar o sistema do cliente-->
                    <h2>Acessar</h2>
