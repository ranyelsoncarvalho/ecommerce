                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="shipping">
                                                <th>Frete</th>
                                            <td>R$ <?php echo formatPrice($cart["vlfreight"]); ?><?php if( $cart["nrdays"] > 0 ){ ?><span> prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</span><?php } ?> <!--mostrar casso seja maior que 1 -->
                                                </td>
                                            </tr>
