    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <?php if( $changePassError != '' ){ ?> <!--variavel para a tratativas de erros de sucesso ou falha-->
                ...
                <form action="/profile/change-password" method="post"> <!--action que o formulario esta chamando-->
                    <div class="form-group">
                    <label for="current_pass">Senha Atual</label> <!--variavel para saber se o usuario digitou a senha-->
