...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <?php if( $msgError != '' ){ ?> <!--variaveis do template a ser carregado-->
        <div class="alert alert-danger alert-dismissible" style="margin:10px">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <p><?php echo htmlspecialchars( $msgError, ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
        </div>
        <?php } ?>
        <?php if( $msgSuccess != '' ){ ?> <!--variaveis do template a ser carregado-->
        ...
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" method="post"> <!--rota para realizar a alteracao da senha-->
          <div class="box-body">
            <div class="form-group">
              <label for="despassword">Nova Senha</label>
              <input type="password" class="form-control" id="despassword" name="despassword" placeholder="Nova senha"> <!--campo senha-->
            </div>
            <div class="form-group">
