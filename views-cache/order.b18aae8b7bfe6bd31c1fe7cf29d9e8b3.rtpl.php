...
<div class="content-wrapper">
    ...
    <h1>
        Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <!--carregando informacoes do pedido-->
    </h1>
    <ol class="breadcrumb">
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?> <!--variavel de produtos-->
                <tr>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo formatPrice($cart["vlsubtotal"]); ?></td> <!--variavel do carrinho-->
                </tr>
                <tr>
                    <th>Frete:</th>
