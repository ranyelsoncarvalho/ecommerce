...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post"> <!--rota para a opcao de editar usuario, quando ele clicar salvar-->
          <div class="box-body">
            <div class="form-group">
              <label for="desperson">Nome</label>
              <!--uso do value, eh para carregar os dados do formulario cadastrado, no caso de edicao-->
            ...
            <div class="checkbox">
              <label>
                <input type="checkbox" name="inadmin" value="1" <?php if( $user["inadmin"] == 1 ){ ?>checked<?php } ?>> Acesso de Administrador <!--verificar se o usuario e adm, se for adm ele vai deixar marcado-->
              </label>
            </div>
          </div>
          <!-- /.box-body -->
