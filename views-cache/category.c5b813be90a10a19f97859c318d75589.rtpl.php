        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center">
                    <h2><?php echo htmlspecialchars( $category["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h2> <!--deixando o nome da categoria de forma dinamca-->
                </div>
            </div>
        </div>
    </div>
...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            <!--loop dos produtos, para serem carregados automaticamente-->
